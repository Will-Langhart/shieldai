...
async function testV2Direct() {
  console.log('🧪 Testing Pinecone v2 Direct Import\n');
  ...
  try {
    ...
    // Try to use the v2 client directly from the newer package
    try {
      console.log('🔍 Trying to import Pinecone v2 directly...');
