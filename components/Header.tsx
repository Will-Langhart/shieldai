  ...
  return (
    <header className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-800/50 backdrop-blur-sm bg-shield-black/50">
      ...
      <div className="flex items-center space-x-2 sm:space-x-4">
        ...
        {/* Buttons */}
        <button className="hidden sm:block px-4 py-2 text-shield-white border border-gray-600/50 rounded-full hover:bg-shield-light-gray/50 transition-all duration-200">
          Sign in
        </button>
        <button className="hidden sm:block px-4 py-2 bg-shield-white text-shield-black rounded-full hover:bg-gray-200 transition-all duration-200 font-medium">
          Sign up
        </button>
      </div>
    </header>
